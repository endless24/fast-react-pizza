      ...
      <Form method="POST">
        ...
        <div className="mb-5 flex gap-2 flex-col sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {formError?.phone && <p className="text-xs mt-2 text-red-700 bg-red-100 p-2 rounded-md">{formError.phone}</p>} {/* error message */}
          </div>
...
export async function action({ request }) {
  ...
  if (Object.keys(order.phone).length > 0) return errors;
